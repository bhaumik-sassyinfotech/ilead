...
class NotificationController extends AdminController {
     ...
     */
     ...
     public function store(Request $request) {
        ...
        if ($notification->save())
            return redirect()->route('notification.index')->with('success', 'Notification '.Config::get('constant.ADDED_MESSAGE'));
    }
     ...
     */
     public function destroy($id) {
        ...
        return redirect()->route('notification.index')->with('success', 'Notification '.Config::get('constant.constant.DELETE_MESSAGE'));
    }
}
