...
class CountryController extends AdminController {
    ...
    public function store(Request $request) {
        ...
        if ($country->save())
            return redirect()->route('country.index')->with('success', 'Country '.Config::get('constant.ADDED_MESSAGE'));
    }
    /**
    ...
    public function update(Request $request, $id) {
        ...
        if ($country->save()) {
            return redirect()->route('country.index')->with('success', 'Country '.Config::get('constant.UPDATE_MESSAGE'));
        } else {
            return redirect()->route('country.create')->with('err_msg', 'Country '.Config::get('constant.TRY_MESSAGE'));;
        }
    }
    ...
    public function destroy($id) {
        $country = Country::findOrFail($id);
        $country->forceDeletes();
        return redirect()->route('country.index')->with('success', 'Country '.Config::get('constant.DELETE_MESSAGE'));;
    }
}
