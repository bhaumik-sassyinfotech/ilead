...
class CurrenciesController extends Controller
{
    ...
    public function update(UpdateCurrenciesRequest $request, $id)
    {
        ...
        return redirect()->route('currencies.index')->with('success', 'Currency '.Config::get('UPDATE_MESSAGE'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('currencies.index')->with('success', 'Currency '.Config::get('DELETE_MESSAGE'));;
    }
