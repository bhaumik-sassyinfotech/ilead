...
class CmsController extends AdminController {
    ...
    public function store(Request $request) {
        ...
        if ($cms->save())
            return redirect()->route('cms.index')->with('success', 'CMS '.Config::get('constant.ADDED_MESSAGE'));
    }
    ...
    public function update(Request $request, $id) {
        ...
        if ($cms->save()) {
            return redirect()->route('cms.index')->with('success', 'CMS '.Config::get('constant.UPDATE_MESSAGE'));;
        } else {
            return redirect()->route('cms.create')->with('success', 'CMS '.Config::get('constant.TRY_MESSAGE'));;
        }
    }
