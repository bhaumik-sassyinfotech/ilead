...
class MessagesController extends AdminController {
    ...
    public function store(Request $request) {
        ...
        if ($messages->save())
            return redirect()->route('messages.index')->with('success', 'Messages '.Config::get('ADDED_MESSAGE'));
    }
     ...
     */
     public function update(Request $request, $id) {
        ...
        if ($messages->save()) {
            return redirect()->route('messages.index')->with('success', 'Messages '.Config::get('UPDATE_MESSAGE'));
        } else {
            return redirect()->route('messages.create')->with('err_msg', 'Messages '.Config::get('TRY_MESSAGE'));
        }
    }
    ...
    public function destroy($id) {
        $messages = Messages::findOrFail($id);
        $messages->delete();
        return redirect()->route('messages.index')->with('success', 'Messages '.Config::get('DELETE_MESSAGE'));
    }
}
