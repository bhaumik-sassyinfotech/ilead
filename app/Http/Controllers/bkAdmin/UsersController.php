...
class UsersController extends AdminController {
    ...
    public function destroy($id) {
        ...
        $user->forceDelete();
        return redirect()->route('users.index')->with('success', 'User '.Config::get('constant.DELETE_MESSAGE'));
    }
...
//        dd($request->all());
    ...
    public function update(Request $request, $id) {
        ...
        return redirect()->route('users.index')->with('success', 'User '.Config::get('constant.UPDATE_MESSAGE'));
    }
