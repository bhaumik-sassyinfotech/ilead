...
class FaqcategoryController extends AdminController {
    ...
    public function store(Request $request) {
        ...
        if ($faqcategorys->save())
            return redirect()->route('faqcategorys.index')->with('success', 'Faq category '.Config::get('ADDED_MESSAGE'));
    }
    ...
    public function update(Request $request, $id) {
        ...
        $faqcategorys->status = $request->status;
        if ($faqcategorys->save()) {
            return redirect()->route('faqcategorys.index')->with('success', 'Faq category '.Config::get('UPDATE_MESSAGE'));
        } else {
            return redirect()->route('faqcategorys.create')->with('err_msg', 'Faq category '.Config::get('TRY_MESSAGE'));
        }
    }
    ...
    public function destroy($id) {
        ...
        return redirect()->route('faqcategorys.index')->with('success', 'Faq category '.Config::get('DELETE_MESSAGE'));
    }
