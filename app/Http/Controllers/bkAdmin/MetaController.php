...
class MetaController extends AdminController {
    ...
    public function store(Request $request) {
        ...
        if ($meta->save())
            return redirect()->route('meta.index')->with('success', 'Meta '.Config::get('ADDED_MESSAGE'));
        }
    ...
    public function update(Request $request, $id) {
        ...
        if ($meta->save()) {
            return redirect()->route('meta.index')->with('success', 'Meta '.Config::get('UPDATE_MESSAGE'));
        } else {
            return redirect()->route('meta.create')->with('err_msg', ' '.Config::get('TRY_MESSAGE'));
        }
    }
    ...
    public function destroy($id) {
        $meta = Meta::findOrFail($id);
        if ($meta->delete())
            return redirect()->route('meta.index')->with('success', 'Meta '.Config::get('DELETE_MESSAGE'));
    }
