...
class FaqmoduleController extends AdminController {
    ...
    public function store(Request $request) {
        ...
        if ($faqmodule->save())
            return redirect()->route('faqmodule.index')->with('success', 'Messages '.Config::get('ADDED_MESSAGE'));
    }
    ...
    public function update(Request $request, $id) {
        ...
        $faqmodule->answer = $request->answer;
        if ($faqmodule->save()) {
            return redirect()->route('faqmodule.index')->with('success', 'FAQ Module '.Config::get('UPDATE_MESSAGE'));
        } else {
            return redirect()->route('faqmodule.create')->with('err_msg', 'FAQ Module '.Config::get('TRY_MESSAGE'));
        }
    }
    ...
    public function destroy($id) {
        ...
        return redirect()->route('faqmodule.index')->with('success', 'FAQ Module '.Config::get('DELETE_MESSAGE'));
    }
