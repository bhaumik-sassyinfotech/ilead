...
class TransactionsController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.transactions.create', $relations);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.transactions.edit', compact('transaction') + $relations);
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.transactions.show', compact('transaction') + $relations);
    }
