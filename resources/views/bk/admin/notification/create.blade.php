...
@section('content')
    <div>
		...
		<div class="col-md-6 pull-right nopadding"><p style="float:right;"><a href="{{ url('/admin/home') }}">Dashboard</a> > <a href="{{ route('notification.index') }}">Notification Pages</a> > Create Notification Pages</p></div>
	</div>
