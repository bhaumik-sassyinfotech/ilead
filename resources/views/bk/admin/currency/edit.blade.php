...
@section('content')
    <div>
		...
		<div class="col-md-6 pull-right nopadding"><p style="float:right;"><a href="{{ url('/admin/home') }}">Dashboard</a> > <a href="{{ route('currency.index') }}">Currency Pages</a> > Edit Currency Pages</p></div>
    </div>
