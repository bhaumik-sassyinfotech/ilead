    ...
    <div class="nav-wrapper tbl  ">
        ...
        <div class="button-wrapper cell">
            <div class="inline-parent">
                ...
                <div class="inline "><a class="main-btn blue-btn" href="#">Sign In</a></div>
            ...
            <div class="container">
                <div id="login" class="carousel slide" data-ride="carousel">
                    <ul class="nav nav-pills nav-justified">
                        <li data-target="#login" data-slide-to="0" class="active"><a href="#">Join Clique</a></li>
                        <li data-target="#login" data-slide-to="1"><a href="#">Sign In</a></li>
                    </ul>
                    <!-- Wrapper for slides -->
...
Other promotions. We respect your privacy.</label></div>
                                ...
                                <input class="main-btn fb-spacing bluelogin-btn btnlg" type="submit" value="JOIN THE COMMUNITY">
                            </form>
