...
<div>
    ...
    <div class="col-md-6 pull-right nopadding"><p style="float:right;"><a href="{{ url('/admin/home') }}">Dashboard</a> > <a href="{{ route('faqcategorys.index') }}">Faqcategorys Pages</a> > Create Faq Categorys</p></div>
</div>
