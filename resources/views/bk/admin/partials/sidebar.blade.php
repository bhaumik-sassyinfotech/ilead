...
<div class="page-sidebar-wrapper">
    <div class="page-sidebar navbar-collapse collapse">
        <ul class="page-sidebar-menu"
            ...
            @if(Helpers::getAdminPermission('transaction.manage')=='true' || Helpers::getAdminPermission('transaction.view')=='true')
            ...
            @endif
            @if(Helpers::getAdminPermission('template.manage')=='true' || Helpers::getAdminPermission('template.view')=='true' || Auth::guard('admin')->user()->role_id == 1)
            <li class="menu-item"> 
                ...
                <ul class="sub-menu-item">
                    ...
                    @if(Helpers::getAdminPermission('template.manage')=='true' || Helpers::getAdminPermission('template.view')=='true')
