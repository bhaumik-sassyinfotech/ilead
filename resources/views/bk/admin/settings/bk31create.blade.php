...
//echo "<pre>";
//   print_r($xml); die; 
//print_r(Helpers::getAdminSetting('twitter')); die;
?>
...
<div>
    ...
    <div class="col-md-6 pull-right nopadding"><p style="float:right;"><a href="{{ url('/admin/home') }}">Dashboard</a> > <a href="{{ route('settings.index') }}">Settings </a> > Settings</p></div>
</div>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="col-md-3">
                ...
                <ul class="page-sidebar-menu"
                    ...
                    data-slide-speed="200">
                        ...
                        <li class="">                   
                          <!--<span style="cursor: pointer" class="title tab_title" id="<?= $tab->attributes()->id; ?>" ><?= $tab->attributes()->label; ?></span>-->							<ul class="nav nav-pills nav-stacked li">							  <li class="active"><a href="#"><?= $tab->attributes()->label; ?></a></li>							  							</ul>
                        </li>
            ...
            <div class="col-md-9">
                ...
                foreach ($xml as $tab) {
                    ?>
                    <div class="container tab tab_for_<?= $tab->attributes()->id; ?>" >
                        ...
                        foreach ($tab as $section) {
                            ...
                            <div class="container section" >
                                <label class="control-label" id="<?= $tab->section->attributes()->id; ?>"><?= $tab->section->attributes()->label; ?></label>
                                <hr>
                                <?php
