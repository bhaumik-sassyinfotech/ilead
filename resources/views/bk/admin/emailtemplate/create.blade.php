...
<div>
    ...
    <div class="col-md-6 pull-right nopadding"><p style="float:right;"><a href="{{ url('/admin/home') }}">Dashboard</a> > <a href="{{ route('emailtemplate.index') }}">Email Templates</a> > Create Email Templates</p></div>
