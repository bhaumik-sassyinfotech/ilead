        ...
        <div class="panel-body commom-form">
            ...
            <div class="row form-group" id="dynamic-div">
				...
				<div class="note-bg">
                        ...
                        <textarea placeholder="Enter notes" name="lead_note_{{ $count }}" id="lead_note_{{ $count }}"
                                  rows="3" class="form-control notes-area txtArea"></textarea>
						<div  class="btn-col">		  
                        <button type="button" name="save" data-id="{{ $count }}" class="btn btn-success saveBtn">Save
                        </button>
                ...
                @else
                    ...
                    @foreach($leadData->notes as $note)
                        ...
                        <div id="notes_{{ $count }}" class="col-md-12 notesContainer">
							<div class="note-bg">
                            <input type="hidden" id="note_id_{{$count}}" name="note_id_{{$count}}" value="{{ $note->note_id }}" >
                            <textarea placeholder="Enter notes" name="lead_note_{{$count}}" id="lead_note_{{$count}}" rows="3" class="form-control notes-area txtArea">{{ nl2br($note->note_desc) }}</textarea>
                            <?php
                            ...
                            @if($allow)
								<div  class="btn-col">
                                <button type="button" data-id="{{$count}}" name="save" class="btn btn-success saveBtn"> Save
                                </button>
