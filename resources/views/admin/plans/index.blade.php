...
<div>
    ...
    <div class="col-md-6 pull-right nopadding"><p style="float:right;"><a href="{{ url('/admin/dashboard') }}">Dashboard</a> > MemberShip Plan</p></div>
</div>
...
<!--                                <td style="text-align:center;">
                    ...
                    <td>
                        @if($plan->status > 0) <span  class="status status_active">Active </span>
                        @else
                    ...
                    <td>
                        ...
                        'method' => 'DELETE',
                        'onsubmit' => "return confirm('".trans("Are you sure want to delete this membership plan?")."');",
