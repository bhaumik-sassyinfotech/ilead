            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group crm-group">
                        ...
                        {{ Form::text('company_name', $leadData['company_name'], ['class' => 'form-control crm-control', 'placeholder' => 'Enter company name', 'maxlength' => 300]) }}
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group crm-group">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group crm-group">
                        ...
                        {{ Form::text('industry', $leadData['industry'] , ['class' => 'form-control crm-control', 'placeholder' => 'Enter industry']) }}
                        {{--<label class="crm-label">Email</label>--}}
                        {{--<input type="email" class="form-control crm-control">--}}
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group crm-group">
                        ...
                        {{ Form::text('phone_number_1', $leadData['phone_number_1'] , ['class' => 'crm-control form-control', 'placeholder' => 'Enter phone number']) }}
                ...
                <div class="col-sm-6">
                    <div class="form-group crm-group">
                        ...
                        {{ Form::text('phone_number_2', $leadData['phone_number_2'] , ['class' => 'crm-control form-control', 'placeholder' => 'Enter phone number']) }}
                        {{--<label class="crm-label">Phone Number</label>--}}
                        {{--<input type="tel" class="form-control crm-control">--}}
                    </div>
                </div>
