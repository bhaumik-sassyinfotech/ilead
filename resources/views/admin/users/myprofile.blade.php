...
@section('content')
    <div>
		<div class="col-md-6 nopadding"><h3 class="page-title">My Profile</h3></div>
		<div class="col-md-6 pull-right nopadding"><p style="float:right;"><a href="{{ url('/admin/dashboard') }}">Dashboard</a> > My Profile</p></div>
	</div>
