...
<div>
    ...
    <div class="col-md-6 pull-right nopadding"><p style="float:right;"><a href="{{ url('/admin/dashboard') }}">Dashboard</a> > Sub Admin</p></div>
</div>
        ...
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>                               
                    ...
                    <td>
                        @if($user->status > 0)  <span  class="status status_active">Active </span>
                        @else
