                    ...
                    <div class="panel-heading">
                        ...
                        <label class="checkbox-inline" style="margin-left: 10px">
                            <input type="checkbox" class="transManage" value="transManage" name="transManage"
                                   {{((Helpers::getAdminPermission('transaction.manage',$role->id)==='true')?'checked':'')}}>Add + Update
                        </label>
                        <label class="checkbox-inline" style="margin-left: 10px">
                            <input type="checkbox" class="transDelete" value="transDelete" name="transDelete"  
                                   {{((Helpers::getAdminPermission('transaction.delete',$role->id)==='true')?'checked':'')}}>Add + Update + Delete
                        </label>
                    ...
                    <div class="panel-heading">
                        ...
                        <label class="checkbox-inline" style="margin-left: 10px">
                            <input type="checkbox" class="faqManage" value="faqManage" name="faqManage"  
                                   {{((Helpers::getAdminPermission('faq.manage',$role->id)==='true')?'checked':'')}}>Add + Update
                        </label>
                        <label class="checkbox-inline" style="margin-left: 10px">
                            <input type="checkbox" class="faqDelete" value="faqDelete" name="faqDelete"  
                                   {{((Helpers::getAdminPermission('faq.delete',$role->id)==='true')?'checked':'')}}>Add + Update + Delete
                        </label>
                        <label class="checkbox-inline">
