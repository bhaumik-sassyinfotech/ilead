...
@section('content')
    <div>
		...
		<div class="col-md-6 pull-right nopadding"><p style="float:right;"><a href="{{ url('/admin/dashboard') }}">Dashboard</a> > <a href="{{ route('notification.index') }}">Notification Pages</a> > Edit Notification Pages</p></div>
    </div>
        ...
        <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-12 col-sm-12 form-group">
                        ...
                        <input type="text" name="identifier" class="form-control" value="{{$notification->identifier}}" readonly="">
