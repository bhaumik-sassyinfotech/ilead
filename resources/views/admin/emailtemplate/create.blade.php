...
<div>
    ...
    <div class="col-md-6 pull-right nopadding"><p style="float:right;"><a href="{{ url('/admin/dashboard') }}">Dashboard</a> > <a href="{{ route('emailtemplate.index') }}">Email Templates</a> > Create Email Templates</p></div>
    <div class="clearfix"></div>
</div>


{{ Form::open(['route'=>['emailtemplate.store'], 'method'=>'post'])}}
    ...
    <div class="panel-body">
        <div class="box-body">
            ...
            <div class="form-group col-sm-6">
                ...
                <input type="text" class="form-control" id="keyword" name="keyword" placeholder="" value="{{$emailtemplate->keyword  or old('keyword') }}" required="">
            ...
            <div class="form-group col-sm-12 ck-editor">
             ...
             <div class="form-group col-sm-12">
                 <label for="content" class="control-label">Macros</label>
                  <input type="text" class="form-control" id="macros" name="macros" placeholder="" value="{{$emailtemplate->macros  or  old('macros') }}">
                <span class="help-block">{{ $errors->first('macros', ':message') }}</span>
            </div>
        <!--    <div class="form-group col-sm-12 ">
                <div class="macros">
                    <label for="content" class="control-label">Macros</label>
                    <label class="control-label">{EMAIL_TO}{USER_NAME}{URL}</label>
                </div>
            </div>      -->
        </div>
    </div>
