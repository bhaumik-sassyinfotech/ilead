...
@section('content')
    <div>
		...
		<div class="col-md-6 pull-right nopadding"><p style="float:right;"><a href="{{ url('/admin/dashboard') }}">Dashboard</a> > <a href="{{ route('country.index') }}">Country Pages</a> > Edit Country Pages</p></div>
    </div>
	{!! Form::model($country, ['method' => 'PUT', 'route' => ['country.update', $country->id]]) !!}
...
<!--                        @if($errors->has('country_name'))
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-12 col-sm-12 form-group">
                        ...
                        <input type="text" name="a_2" class="form-control" value="{{$country->a_2}}">
                        <p class="help-block"></p>
<!--                        @if($errors->has('a_2'))
                            <p class="help-block">
                                {{ $errors->first('a_2') }}
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-12 col-sm-12 form-group">
                        ...
                        <input type="text" name="a_3" class="form-control" value="{{$country->a_3}}">
                        <p class="help-block"></p>
<!--                        @if($errors->has('a_3'))
                            <p class="help-block">
                                {{ $errors->first('a_3') }}
