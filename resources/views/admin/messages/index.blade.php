...
<div>
    ...
    <div class="col-md-6 pull-right nopadding"><p style="float:right;"><a href="{{ url('/admin/dashboard') }}">Dashboard</a> > Messages Pages</p></div>
</div>
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <table class="table table-bordered table-striped">
            ...
            <tr>
                <td style="width: 10%">{{$messages->id}}</td>
                ...
                <td style="width: 20%">
                    ...
                    'method' => 'DELETE',
                    'onsubmit' => "return confirm('".trans("Are you sure want to delete this message?")."');",
