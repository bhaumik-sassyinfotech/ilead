...
<div>
    ...
    <div class="col-md-6 pull-right nopadding"><p style="float:right;"><a href="{{ url('/admin/dashboard') }}">Dashboard</a> > Meta Pages</p></div>
</div>
        ...
        <table class="table table-bordered table-striped">
            ...
            <tr>
                ...
                <td style="width: 15%">
                    ...
                    'method' => 'DELETE',
                    'onsubmit' => "return confirm('".trans("Are you sure want to delete this meta?")."');",
