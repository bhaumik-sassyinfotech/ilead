...
@section('content')
    <div>
		...
		<div class="col-md-6 pull-right nopadding"><p style="float:right;"><a href="{{ url('/admin/dashboard') }}">Dashboard</a> > <a href="{{ route('meta.index') }}">Meta Pages</a> > Edit Meta Pages</p></div>
	</div>
