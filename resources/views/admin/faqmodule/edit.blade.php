...
<div>
    ...
    <div class="col-md-6 pull-right nopadding"><p style="float:right;"><a href="{{ url('/admin/dashboard') }}">Dashboard</a> > <a href="{{ route('faqmodule.index') }}">Faq Module</a> > Edit Faq Module</p></div>
</div>
